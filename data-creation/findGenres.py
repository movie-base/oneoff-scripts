"""
	...
	[
		('Drama', 15467), ('Comedy', 10394), ('Romance', 4995), ('Action', 4434),
		('Crime', 4303), ('Thriller', 4001), ('Documentary', 3391), ('Horror', 3363),
		('Adventure', 3217), ('Mystery', 1992), ('Fi', 1791), ('Sci', 1791), ('Family', 1770),
		('Biography', 1678), ('Fantasy', 1670), ('Animation', 1387), ('History', 1176),
		('Short', 1155), ('Music', 1123), ('War', 973), ('Western', 765), ('Musical', 737),
		('Sport', 610), ('Noir', 354), ('Film', 354), ('News', 73), ('Adult', 24),
		('Show', 24), ('TV', 15), ('Reality', 15), ('Talk', 13), ('Game', 11),
	]
"""
